            ...
            <div class="leftside-header">
                <div class="logo">
                    <a href="index.html" class="on-click">
                        <img alt="logo" src="{{asset('admin/')}}/images/header-logo.png" />
                    </a>
                </div>
                                ...
                                <div class=" gallery-wrap">
                                    <div class="row">
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="first photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="second photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="third photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="fourth photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="fifth photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="sixth photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="seventh photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="col-xs-6 col-md-3">
                                            <a href="{{asset('admin/')}}/images/helsinki-lg.jpg" title="By John Doe">
                                                <img alt="eighth photo" src="{{asset('admin/')}}/images/helsinki.jpg" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="nano-content">
                        <div class="template-settings">
                            ...
                            <div class="row toggle-colors">
                                ...
                                <div class="col-xs-6">
                                    <a href="http://myiideveloper.com/helsinki/last-version/helsinki_green-light/src/index.html" class="on-click"> <img alt="Helsinki-green" src="{{asset('admin/')}}/images/theme/white_green.png" /></a>
                                </div>
                            </div>
                            <div class="row toggle-colors">
                                <div class="col-xs-6">
                                    <a href="http://myiideveloper.com/helsinki/last-version/helsinki_dark/src/index.html" class="on-click"> <img alt="Helsinki-green" src="{{asset('admin/')}}/images/theme/dark_white.png" /></a>
                                </div>
                                <div class="col-xs-6">
                                    <a href="http://myiideveloper.com/helsinki/last-version/helsinki_light/src/index.html" class="on-click"> <img alt="Helsinki-green" src="{{asset('admin/')}}/images/theme/white_dark.png" /></a>
                                </div>
                            </div>
                            <div class="row toggle-colors">
                                <div class="col-xs-6">
                                    <a href="http://myiideveloper.com/helsinki/last-version/helsinki_blue-dark/src/index.html" class="on-click"> <img alt="Helsinki-green" src="{{asset('admin/')}}/images/theme/dark_blue.png" /></a>
                                </div>
                                <div class="col-xs-6">
                                    <a href="http://myiideveloper.com/helsinki/last-version/helsinki_blue-light/src/index.html" class="on-click"> <img alt="Helsinki-green" src="{{asset('admin/')}}/images/theme/white_blue.png" /></a>
                                </div>
                            </div>
                            <div class="row mt-lg">
